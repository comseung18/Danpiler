...
class SLRParserTest {
    ...
    fun testIfStatement() {
        ...
        val input = listOf(ConstTerminalItem("if"), ConstTerminalItem("("), ConstTerminalItem("id"), ConstTerminalItem(")"), ConstTerminalItem("a"))
        val result = parser.parse(input)
    ...
    fun testInvalidInput() {
        ...
        val input = listOf(ConstTerminalItem("b"), ConstTerminalItem("a")) // 잘못된 순서
        val result = parser.parse(input)
